...
class MainActivity : AppCompatActivity() {
    ...
    private fun get_list_of_fruits():List<Fruit>{
        ...
        fruits.add(Fruit("Watermelon",R.drawable.bate5,15.0,30))
        fruits.add(Fruit("Peach",R.drawable.peach,22.0,64))
        fruits.add(Fruit("Dragon Fruit",R.drawable.dragon_fruit,120.0,10))
        fruits.add(Fruit("Banana",R.drawable.banana,18.0,24))
        fruits.add(Fruit("Strawberry",R.drawable.frawla,30.0,35))
        fruits.add(Fruit("Kewy",R.drawable.kewy,38.0,25))
        fruits.add(Fruit("Potato",R.drawable.btats,10.0,60))
        fruits.add(Fruit("Apple",R.drawable.red_apple,25.0,30))
        fruits.add(Fruit("Mango",R.drawable.mango,30.5,50))
        fruits.add(Fruit("Watermelon",R.drawable.bate5,15.0,30))
        fruits.add(Fruit("Peach",R.drawable.peach,22.0,64))
